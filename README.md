...
Davoid is a professional-grade Terminal User Interface (TUI) toolkit for ethical hacking, network discovery, and security auditing. Built with Python and Scapy, it offers a high-contrast, aggressive aesthetic while providing deep-level network manipulation capabilities.
...
Developed by Bryan Parreira GitHub: BryanParreira/Davoid
```
