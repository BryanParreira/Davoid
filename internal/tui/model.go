...
func loadChecklistView(engID string) tea.Cmd {
	return func() tea.Msg {
		...
		phases := []struct {
			...
			{"Reconnaissance", "2.", []string{"recon"}, nil},
			{"Network & MITM", "3.", []string{"net_intercept"}, nil},
...
func (m Model) viewMainMenu() string {
	...
	sb.WriteString("\n")
	sb.WriteString(StyleHelp.Render("  ↑/↓  ·  enter  ·  1-9 quick jump  ·  [?] help  ·  [Q] quit"))
	sb.WriteString("\n")
...
func (m Model) viewHelp() string {
	...
	help := []struct{ k, d string }{
		...
		{"1-9", "Open module category  (7=WiFi  8=Advanced  9=WebScan)"},
