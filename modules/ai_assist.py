...
# ─────────────────────────────────────────────────────────────────────────────
#  AGENT TOOLS (Functions the AI can execute on its own)
# ─────────────────────────────────────────────────────────────────────────────
    ...
    def __init__(self, model: str = None):
        ...
        self.tools = [
            Tool(
                ...
                description="Useful for when you need to know what vulnerabilities or targets have been found during the penetration test."
            ),
            Tool(
                name="PingTarget",
                func=tool_ping_target,
                description="Useful for when you need to check if an IP address is online. Input should be exactly an IP address (e.g. 192.168.1.5)."
            )
        ]
        ...
        self.agent = initialize_agent(
            ...
            agent_kwargs={
                "system_message": (
                    ...
                    "Use your tools if you need context to answer the user's question."
                )
            }
        )
